...
public class FriendshipsMongo {
    private IFriendsCollection friends;

    public FriendshipsMongo() throws UnknownHostException {
        this(new FriendsCollection());
    }
    public FriendshipsMongo(IFriendsCollection friendsCollection){
